  ...
  return (
    <nav className={`${styles.paddingX} w-full flex items-center py-5 fixed top-0 z-20 bg-primary`}>
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        >
          <img src={logo} alt="Logo" className="w-9 h-9 object-contain rounded-full mx-1" />
          <p className="text-white text-[18px] font-bold cursor-pointer flex">Sanchet&nbsp;<span className="sm:block hidden">| Developer</span></p>
        </Link>
